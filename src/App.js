...
const days = [
  ...
  },
  {
    ...
    items: [
      { time: "09:00 \u2013 12:00", title: "Morning \u2014 Work or Explore", desc: "Sleep in, or head to a 24/7 caf\u00E9 nearby (see Caf\u00E9s tab!). C Asean is 24/7 & FREE, just 10 min away.", type: "activity" },
      { time: "12:00 \u2013 14:00", title: "Lunch in Silom/Chong Nonsi", desc: "Walk to nearby Silom for lunch. Thai Taste Hub at Mahanakhon building.", type: "food" },
  ...
  },
  {
    ...
    items: [
      { time: "10:00 \u2013 13:00", title: "Dib Museum Bangkok", desc: "Thailand's FIRST international contemporary art museum! Dec 2025. Repurposed 1980s warehouse. 81 works by 40 artists \u2014 Turrell, Hirst, Boonma.", type: "activity", details: [
        ...
        { label: "Transport", value: "BTS Chong Nonsi \u2192 Phra Khanong (6 stops), then Grab 5 min" },
